...
def main():
    print("=== DEVAI (PyTorch) | Kasım Class-wise ===")
    device = "cuda" if torch.cuda.is_available() else "cpu"
    print("Device:", device)

    ds = get_dataset()

    run_classwise("Kasim_Model1_ResNet18Transfer", create_kasim_m1, ds, device, epochs=1)
    run_classwise("Kasim_Model2_SEAttentionCNN", create_kasim_m2, ds, device, epochs=1)
